...
{
	/// Getters
	std::vector<openGL::Mesh>& Model::Meshes() { return _meshes; }
	/// -------
	...
	void Model::LoadModel(std::string filepath) throw(std::exception)
	{
	...
	void Model::Draw(openGL::Program* program) const
	{
	...
	openGL::Mesh Model::ProcessMesh(aiMesh* mesh, const aiScene* scene)
	{
	...
	std::vector<openGL::Texture> Model::LoadTexture(aiMaterial* material, aiTextureType type)
	{
		std::vector<openGL::Texture> textures;
